...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2023-07-25T19:56:07Z"), u1);
        Order o2 = new Order(null, Instant.parse("2023-07-27T22:36:57Z"), u2);
        Order o3 = new Order(null, Instant.parse("2014-12-12T00:00:00Z"), u1);
